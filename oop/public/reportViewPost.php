...
<div class="container " style="max-width: 701px">
            <div class="wrapper  alert alert-danger">
                ...
                <div class="col-2">
                    <img class=" img-target item-center-block img-thumbnail" src="<?php echo $reportedUserDetail->profileImgPath ?>" style="z-index: 2;" onerror="this.src='../asset/placeholder.png';" alt="Your Image Goes Here" src="#">
                </div>
                    <h6 class="col-9">Reported User : <a href="viewProfile.php?user=<?php echo $reportedUserDetail->usr_id ?>"><?php echo $reportedUserDetail->usrnm ?></a></h6>
                </div>
            </div>
            <hr>
            <div class="wrapper  alert alert-success">
                ...
                <div class="row">
                    <div class="col-2">
                        <img class=" img-target item-center-block img-thumbnail" src="<?php echo $reportFromUserDetail->profileImgPath ?>" style="z-index: 2;" onerror="this.src='../asset/placeholder.png';" alt="Your Image Goes Here" src="#">
                    </div>
                <h6 class="col-9">Reported By : <a href="viewProfile.php?user=<?php echo $reportFromUserDetail->usr_id ?>"><?php echo $reportFromUserDetail->usrnm ?></a></h6>
            </div>
            </div>
            <h6>Report Title : <?php echo ($reportDetails->report_title == null) ? 'Preset' : $reportDetails->report_title; ?></a></h6>
