...
?>
    ...
    <div class="container container-full container-sm">
        <center>
            ...
            <form method="">
                <input class="form-control" type="text" name="terms" minlength=3 placeholder="Search" value="<?php echo Input::get('terms') ?>" aria-label="Search">
...
$search->genCards($terms,Input::get('choice'));
echo "</div></center>";
